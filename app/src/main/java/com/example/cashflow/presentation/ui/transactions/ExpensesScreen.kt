...
fun ExpensesScreen(innerPaddings: PaddingValues, viewModel: ExpensesViewModel) {
    ...
    val outcomes by viewModel.outcomes
    ...
    Scaffold(modifier = Modifier.padding(innerPaddings), floatingActionButton = {
        ...
        when (outcomes) {
            ...
            is UiState.Success -> {
                val theOutcomes = (outcomes as UiState.Success).data
                if (theOutcomes.isEmpty()) {
                    Text(
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(16.dp),
        ...
        if (showSheet) {
            ModalBottomSheet(
                ...
                NewExpenseScreen({ showSheet = !showSheet }, viewModel)
            }
        }
